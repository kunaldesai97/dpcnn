...
# train_dset = torch.utils.data.Subset(train_dataset, list(range(0, 555000)))
# valid_dset = torch.utils.data.Subset(train_dataset, list(range(555000, 560000)))

# train_dset, valid_dset = torch.utils.data.random_split(train_dataset, [550000, 10000])
